...
// LMiTerm Edit: Silence ignorable errors
...
- (void)doGoldenTestForInput:(NSString *)input
    ...
    if (createGolden) {
        ...
        if (!golden) {
            golden = [[NSBundle bundleForClass:self.class] imageForResource:[self shortNameForGolden:name]]; // LMiTerm Edit: Change bundle
        }
