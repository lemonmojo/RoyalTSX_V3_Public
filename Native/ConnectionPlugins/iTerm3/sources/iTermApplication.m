...
+ (iTermApplication *)sharedApplication {
    // LMiTerm Edit: Return the shared instance of LMiTermApplication instead of the regular NSApplication. This allows to use iTerm without needing to implement any methods in AppDelegate
    return [NSClassFromString(@"LMiTermApplication") sharedApplication];
