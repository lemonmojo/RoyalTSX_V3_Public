...
+ (NSImage *)bellImage {
    return [[NSBundle bundleForClass:self.class] imageForResource:@"important"]; // LMiTerm Edit: Change
}
...
+ (NSImage *)imageForNewOutput {
    ...
    switch (preferredStyle) {
        ...
        case TAB_STYLE_LIGHT_HIGH_CONTRAST:
            return [[NSBundle bundleForClass:self.class] imageForResource:@"NewOutput"]; // LMiTerm Edit: Change
        case TAB_STYLE_DARK:
        case TAB_STYLE_DARK_HIGH_CONTRAST:
            return [[NSBundle bundleForClass:self.class] imageForResource:@"NewOutputForDarkTheme"]; // LMiTerm Edit: Change
    }
...
+ (NSImage *)deadImage {
    ...
    switch (preferredStyle) {
        case TAB_STYLE_LIGHT:
        case TAB_STYLE_LIGHT_HIGH_CONTRAST:
            return [[NSBundle bundleForClass:self.class] imageForResource:@"dead"]; // LMiTerm Edit: Change
        case TAB_STYLE_DARK:
        case TAB_STYLE_DARK_HIGH_CONTRAST:
            return [[NSBundle bundleForClass:self.class] imageForResource:@"DeadForDarkTheme"]; // LMiTerm Edit: Change
    }
    return [[NSBundle bundleForClass:self.class] imageForResource:@"dead"]; // LMiTerm Edit: Change
}
