...
#import "PTYWindow.h"
// LMiTerm Edit: No need for UKCrashReporter when embedding iTerm
...
- (void)setCurrentTerminal:(PseudoTerminal *)thePseudoTerminal {
    ...
    if ([thePseudoTerminal windowInitialized] && [[thePseudoTerminal window] isKeyWindow] == NO) {
        // LMiTerm Edit: This may cause an infinite loop because we handle first responders and key windows differently than regular iTerm
