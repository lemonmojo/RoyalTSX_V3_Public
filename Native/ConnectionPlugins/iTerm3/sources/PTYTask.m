...
- (void)launchWithPath:(NSString *)progpath
    ...
    // LMiTerm Edit: environ doesn't seem to work for me so use old method
    ...
    if (pid == (pid_t)0) {
        ...
        extern char **environ;
        environ = newEnviron; */
        // LMiTerm Edit: TODO, this for loop was copied from previous version, is it really required
        for (i = 0; i < envsize; i++) {
