...
- (BOOL)resignFirstResponder {
    ...
    // LMiTerm Edit: Required to actually get the cursor to "unfill"
...
// LMiTerm Edit: Required to get the state of this property
- (BOOL)showTimestamps
{
    return _drawingHelper.showTimestamps;
}

// LMiTerm Edit: Required to set the state of this property
...
// LMiTerm Edit: We want to handle swipes ourselves
...
- (NSMenu *)menuAtCoord:(VT100GridCoord)coord {
    ...
    // Split pane options
    // LMiTerm Edit: No splitting or moving of panes and sessions in embedded iTerm
    ...
    // Edit Session
    // LMiTerm Edit: No editing of sessions in embedded iTerm
    ...
    // LMiTerm Edit: No closing or restarting of sessions in embedded iTerm
    /* // Separator
    [theMenu addItem:[NSMenuItem separatorItem]];
