...
- (instancetype)initWithFrame:(NSRect)frame {
    ...
    if (self) {
        ...
        NSImage *closeImage = [[NSBundle bundleForClass:self.class] imageForResource:@"closebutton"]; // LMiTerm Edit: Change bundle
        ...
        menuButton_.image = [[NSBundle bundleForClass:self.class] imageForResource:@"Hamburger"]; // LMiTerm Edit: Change bundle
